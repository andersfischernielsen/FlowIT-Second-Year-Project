...
namespace Server.Storage
{
    public class CacheStorage : IServerStorage
    {
        ...
        private CacheStorage()
        {
            ...
            {
                new ServerUserModel(){ID = 1,Name="Wind",ServerRolesModels = new List<ServerRolesModel>{new ServerRolesModel(){ID="Teacher",ServerUserModelID = 1, ServerWorklowModelID = "Test1"}}},
                new ServerUserModel(){ID = 1,Name="Wind",ServerRolesModels = new List<ServerRolesModel>{new ServerRolesModel(){ID="Student",ServerUserModelID = 1, ServerWorklowModelID = "Test1"}}},
